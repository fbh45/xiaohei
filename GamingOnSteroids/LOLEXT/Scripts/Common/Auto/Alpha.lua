...
AlphaMenu:MenuElement({id = "Performance", name = "性能", type = MENU})
AlphaMenu.Performance:MenuElement({id = "MissileCache", name = "导弹缓存时间", value = _G.missileRecacheTimeOut, min = 10, max = 1000, step = 10, callback = function(delay) MISSILE_CACHE_DELAY = delay end })
AlphaMenu.Performance:MenuElement({id = "ParticleCache", name = "粒子缓存时间", value = _G.particleRecacheTimeOut, min = 10, max = 1000, step = 10, callback = function(delay) PARTICLE_CACHE_DELAY = delay end })
AlphaMenu.Performance:MenuElement({id = "BuffCache", name = "增益缓存时间", value = 150, min = 10, max = 1000, step = 10, callback = function(delay) BUFF_CACHE_DELAY = delay end })

AlphaMenu:MenuElement({id = "PrintDmg", name = "打印伤害警告", value = false})
AlphaMenu:MenuElement({id = "PrintBuff", name = "打印创建的增益", value = false})
AlphaMenu:MenuElement({id = "PrintMissile", name = "打印导弹创建", value = false})
AlphaMenu:MenuElement({id = "PrintSkill", name = "打印使用技能", value = false})
