...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]欺诈宝珠", type = MENU})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]妖异狐火", type = MENU})
	Menu.Skills.W:MenuElement({id = "Radius", name = "使用半径", value = 250, min = 0, max = 1000, step = 50 })
	Menu.Skills.W:MenuElement({id = "Mana", name = "最小法力", value = 20, min = 1, max = 100, step = 1 })

	Menu.Skills:MenuElement({id = "E", name = "[E]魅惑妖术", type = MENU})
	...
	Menu.Skills:MenuElement({id = "R", name = "[R]灵魄突袭", type = MENU})
	Menu.Skills.R:MenuElement({id = "Auto", name = "危险等级（自动）", value = 4, min = 1, max = 6, step = 1 })
	Menu.Skills.R:MenuElement({id = "Combo", name = "危险等级（走砍）", value = 1, min = 1, max = 6, step = 1 })
