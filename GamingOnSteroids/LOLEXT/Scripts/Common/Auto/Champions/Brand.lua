...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]火焰烙印", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Accuracy", name = "准确度", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.Q:MenuElement({id = "Auto", name = "自动眩晕", value = true})
	
	Menu.Skills:MenuElement({id = "W", name = "[W]烈焰之柱", type = MENU})
	Menu.Skills.W:MenuElement({id = "AccuracyCombo", name = "走砍精度", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.W:MenuElement({id = "AccuracyAuto", name = "自动施放精度", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.W:MenuElement({id = "Auto", name = "自动固定施放", value = true })
	Menu.Skills.W:MenuElement({id = "Mana", name = "自动施放法力", value = 30, min = 1, max = 100, step = 5 })
	
	Menu.Skills:MenuElement({id = "E", name = "[E]烈火燃烧", type = MENU})
	Menu.Skills.E:MenuElement({id = "Mana", name = "自动施放法力", value = 15, min = 1, max = 100, step = 5 })
	Menu.Skills.E:MenuElement({id = "Targets", name = "自动骚扰目标", type = MENU})
	...
	Menu.Skills:MenuElement({id = "R", name = "[R]烈焰风暴", type = MENU})
	Menu.Skills.R:MenuElement({id = "Count", name = "自动施放敌人数", value = 3, min = 1, max = 6, step = 1 })	
	Menu.Skills.R:MenuElement({id = "Auto", name = "自动施放", value = false})
