...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]瘟毒爆炸", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Auto", name = "自动固定施放", value = true})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]剧毒迷雾", type = MENU})
	Menu.Skills.W:MenuElement({id = "Auto", name = "自动固定施放", value = true})
	Menu.Skills.W:MenuElement({id = "Count", name = "自动施放目标＃", value = 2, min = 1, max = 6, step = 1})
	...
	Menu.Skills:MenuElement({id = "E", name = "[E]双生毒牙", type = MENU})
	Menu.Skills.E:MenuElement({id = "Poison", name = "只施放在中毒的敌人身上", value = false})
	Menu.Skills.E:MenuElement({id = "FarmPoison", name = "只对中毒的小兵施放", value = false, toggle = true})
	Menu.Skills.E:MenuElement({id = "Farm", name = "E 最后一击（切换）", value = false, toggle = true, key = 0x72})
	Menu.Skills.E:MenuElement({id = "Mana", name = "法力限制", value = 15, min = 5, max = 100, step = 5 })
	
	Menu.Skills:MenuElement({id = "R", name = "[R]石化凝视", type = MENU})
	Menu.Skills.R:MenuElement({id = "Assist", name = "手动大招键",value = false,  key = 0x73})	
	Menu.Skills.R:MenuElement({id = "Range", name = "范围限制", value = 95, min = 10, max = 100, step = 5 })
	Menu.Skills.R:MenuElement({id = "Targets", name = "眩晕目标", type = MENU})	
	...
	Menu.Skills.R:MenuElement({id = "Auto", name = "自动大招", value = false})
	Menu.Skills.R:MenuElement({id = "Count", name = "大招攻击＃个敌人", value = 2, min = 1, max = 6, step = 1 })	
	
	Menu.Skills:MenuElement({id = "AA", name = "使用自动攻击在走砍", value = true})
