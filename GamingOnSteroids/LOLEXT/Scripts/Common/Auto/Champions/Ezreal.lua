...
function LoadScript()
	...
	Menu.Skills:MenuElement({	id = "Q",	name = "[Q]秘术射击",	type = MENU	})
	Menu.Skills.Q:MenuElement({	id = "Auto",	name = "自动AA重置",	value = true	})
	Menu.Skills.Q:MenuElement({	id = "Killsteal",	name = "斩杀",	value = true	})
	Menu.Skills.Q:MenuElement({	id = "AutoAccuracy",	name = "自动精度",	value = 3,	min = 1,	max = 6,	step = 1	})
	Menu.Skills.Q:MenuElement({	id = "Accuracy",	name = "走砍精度",	value = 2,	min = 1,	max = 6,	step = 1	})
	Menu.Skills.Q:MenuElement({	id = "Farm",	name = "清小兵使用",	value = false	})
	Menu.Skills.Q:MenuElement({id = "Mana", name = "法力限制", value = 15, min = 1, max = 100, step = 1 })
		
	Menu.Skills:MenuElement({	id = "W",	name = "[W]精华跃动",	type = MENU	})
	Menu.Skills.W:MenuElement({	id = "Auto",	name = "AA使用后",	value = false	})
	Menu.Skills.W:MenuElement({	id = "Immobile",	name = "自动固定施放",	value = false	})
	Menu.Skills.W:MenuElement({	id = "Killsteal",	name = "斩杀",	value = true	})
	Menu.Skills.W:MenuElement({	id = "Accuracy",	name = "走砍精度",	value = 3,	min = 1,	max = 6,	step = 1	})
	Menu.Skills.W:MenuElement({id = "Mana", name = "法力限制", value = 30, min = 1, max = 100, step = 1 })
		
	Menu.Skills:MenuElement({id = "E",	name = "[E]奥术跃迁",	type = MENU})
	Menu.Skills.E:MenuElement({id = "EvadeCC",	name = "自动躲避控制",	value = true	})
	Menu.Skills.E:MenuElement({id = "EvadeDanger",	name = "走砍闪避危险等级",	value = 2,	min = 1,	max = 6,	step = 1	})
	Menu.Skills.E:MenuElement({id = "Mana", name = "法力限制", value = 20, min = 1, max = 100, step = 1 })	
		
	Menu.Skills:MenuElement({id = "R", name = "[R]精准弹幕", type = MENU})
	Menu.Skills.R:MenuElement({id = "Count", name = "走砍目标数量", value = 3, min = 1, max = 6,	step = 1 })
	Menu.Skills.R:MenuElement({id = "Radius", name = "走砍最小敌人范围", value = 700, min = 100, max = 2000,	step = 100 })
	Menu.Skills.R:MenuElement({id = "Assist", name = "辅助键",value = false,  key = 0x73})
