...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]破空斩", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Auto", name = "自动命中破绽", value = true})
	Menu.Skills.Q:MenuElement({id = "DodgeAuto", name = "闪避危险等级（自动）", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.Q:MenuElement({id = "DodgeCombo", name = "闪避危险等级（走砍）", value = 2, min = 1, max = 6, step = 1 })
	Menu.Skills.Q:MenuElement({id = "Mana", name = "法力限制", value = 15, min = 5, max = 100, step = 5 })
	
		
	Menu.Skills:MenuElement({id = "W", name = "[W]劳伦特心眼刀", type = MENU})
	Menu.Skills.W:MenuElement({id = "Auto", name = "自动格挡", value = true})
	Menu.Skills.W:MenuElement({id = "Mana", name = "法力限制", value = 15, min = 5, max = 100, step = 5 })
	
	Menu.Skills:MenuElement({id = "E", name = "[E]夺命连刺", type = MENU})
	Menu.Skills.E:MenuElement({id = "Auto", name = "AA重置", value = true})
