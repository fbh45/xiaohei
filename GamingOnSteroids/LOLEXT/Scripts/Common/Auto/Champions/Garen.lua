...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]致命打击", type = MENU	})
	Menu.Skills.Q:MenuElement({id = "Auto", name = "AA重置", value = true	})
	Menu.Skills.Q:MenuElement({id = "Radius",	name = "走砍距离<X",	value = 500,	min = 100,	max = 700,	step = 25	})
		
	Menu.Skills:MenuElement({id = "W",	name = "[W]勇气",	type = MENU})
	Menu.Skills.W:MenuElement({id = "CC",	name = "在预期时使用控制",	value = true	})
		
	Menu.Skills:MenuElement({id = "E", name = "[E]审判", type = MENU})
	Menu.Skills.E:MenuElement({id = "Combo",	name = "走砍施放",	value = true	})
	
		
	Menu.Skills:MenuElement({id = "R", name = "[R]德玛西亚正义", type = MENU})
