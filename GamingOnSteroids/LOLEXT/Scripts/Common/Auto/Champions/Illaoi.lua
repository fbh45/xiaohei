...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]触手猛击", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Auto", name = "在固定自动施放", value = true})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]严酷训诫", type = MENU})
	Menu.Skills.W:MenuElement({id = "Auto", name = "攻击重置", value = true})
	...
	Menu.Skills:MenuElement({id = "E", name = "[E]灵魂试炼", type = MENU})
	Menu.Skills.E:MenuElement({id = "Auto", name = "在固定自动施放", value = true})
	...
	Menu.Skills:MenuElement({id = "R", name = "[R]过界信仰", type = MENU})
	Menu.Skills.R:MenuElement({id = "Count", name = "目标数量", value = 3, min = 1, max = 6, step = 1})
	Menu.Skills.R:MenuElement({id = "Mana", name = "法力限制", value = 15, min = 5, max = 100, step = 5 })
