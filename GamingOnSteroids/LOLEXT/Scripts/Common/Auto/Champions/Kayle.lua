...
function LoadScript()
	...
	Menu.Skills:MenuElement({	id = "Q",	name = "[Q]耀焰冲击", type = MENU})	
	Menu.Skills.Q:MenuElement({	id = "Radius",	name = "自动剥离半径",	value = 0,	min = 0,	max = 650,	step = 1	})
	Menu.Skills.Q:MenuElement({	id = "Harass",	name = "在骚扰中使用",	value = true	})
	Menu.Skills.Q:MenuElement({	id = "Combo",	name = "在走砍中使用",	value = true	})
	Menu.Skills.Q:MenuElement({	id = "Killsteal",	name = "斩杀",	value = true,	toggle = true	})
	Menu.Skills.Q:MenuElement({	id = "Mana",	name = "最小法力",	value = 20,	min = 1,	max = 100	})
		
	Menu.Skills:MenuElement({	id = "W",	name = "[W]星界恩典",	type = MENU	})
	Menu.Skills.W:MenuElement({id = "Auto", name = "自动施放（无走砍）", value = true, toggle = true })
	...
	Menu.Skills.W:MenuElement({id = "Mana", name = "法力限制", value = 20, min = 5, max = 100, step = 5 })
		
		
	Menu.Skills:MenuElement({id = "E", name = "[E]星火符刃", type = MENU})	
	Menu.Skills.E:MenuElement({	id = "Harass",	name = "在骚扰中使用",	value = true	})
	Menu.Skills.E:MenuElement({	id = "Combo",	name = "在走砍中使用",	value = true	})
	Menu.Skills.E:MenuElement({id = "Mana", name = "最小法力", value = 15, min = 1, max = 100, step = 1 })
		
		
	Menu.Skills:MenuElement({id = "R", name = "[R]圣裁之刻", type = MENU})
	Menu.Skills.R:MenuElement({id = "Auto", name = "自动施放（无走砍）", value = true, toggle = true })
	...
	Menu.Skills.R:MenuElement({	id = "TargetCC",	name = "传入控制目标设置",	type = MENU	})
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
		if hero and hero.isAlly then
	...
	Menu.Skills.R:MenuElement({	id = "Gapcloser",	name = "反Gapcloser设置",	type = MENU	})
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
