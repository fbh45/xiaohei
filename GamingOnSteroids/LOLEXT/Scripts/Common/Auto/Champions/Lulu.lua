...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]闪耀长枪", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Accuracy", name = "走砍精度", value = 3, min = 1, max = 6, step = 1 })	
	Menu.Skills.Q:MenuElement({id = "Auto", name = "对固定目标自动施放", value = true, toggle = true })
	Menu.Skills.Q:MenuElement({id = "Mana", name = "最小法力", value = 20, min = 1, max = 100, step = 1 })
		
	Menu.Skills:MenuElement({id = "W", name = "[W]奇思妙想", type = MENU})
	Menu.Skills.W:MenuElement({id = "Auto", name = "自动剥离", value = true, toggle = true })
	Menu.Skills.W:MenuElement({id = "Radius", name = "虚弱半径", value = 350, min = 100, max = 800, step = 50 })
	Menu.Skills.W:MenuElement({id = "Targets", name = "目标列表", type = MENU})
	...
	Menu.Skills:MenuElement({id = "E", name = "[E]帮忙，皮克斯！", type = MENU})	
	Menu.Skills.E:MenuElement({id = "Targets", name = "盾目标", type = MENU})	
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
	...
	Menu.Skills.E:MenuElement({id = "Damage", name = "伤害格挡", value = 125, min = 50, max = 1000, step = 50 })
	Menu.Skills.E:MenuElement({id = "Auto", name = "自动盾", value = true, toggle = true })
	Menu.Skills.E:MenuElement({id = "Mana", name = "最小法力", value = 20, min = 1, max = 100, step = 1 })
		
		
	Menu.Skills:MenuElement({id = "R", name = "[R]狂野生长", type = MENU})
	Menu.Skills.R:MenuElement({id = "Targets", name = "目标", type = MENU})
	Menu.Skills.R:MenuElement({id = "Auto", name = "自动施放", value = true, toggle = true })
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
		if hero and hero.isAlly then
	...
	Menu.Skills.R:MenuElement({id = "Damage", name = "最小的伤害", value = 100, min = 50, max = 1000, step = 50 })
	Menu.Skills.R:MenuElement({id = "Count", name = "敌人数量", value = 2, min = 1, max = 6, step = 1 })		
