...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]光之束缚", type = MENU})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]曲光屏障", type = MENU})
	Menu.Skills.W:MenuElement({id = "Damage", name = "最小伤害", value = 200, min = 100, max = 1000, step = 25 })
	Menu.Skills.W:MenuElement({id = "Count", name = "最低目标", value = 1, min = 1, max = 6, step = 1 })
	Menu.Skills.W:MenuElement({id = "Mana", name = "最小法力", value = 20, min = 1, max = 100, step = 1 })
		
	Menu.Skills:MenuElement({id = "E", name = "[E]透光奇点", type = MENU})
	...
	Menu.Skills.E:MenuElement({id = "Targets", name = "爆发目标", type = MENU})	
	...
	Menu.Skills:MenuElement({id = "R", name = "[R] 终极闪光", type = MENU})
	Menu.Skills.R:MenuElement({id = "Accuracy", name = "准确度", value = 2, min = 1, max = 6, step = 1 })
	Menu.Skills.R:MenuElement({id = "Combo", name = "仅走砍", value = false })
	...
	Menu.Skills.R:MenuElement({id = "Killsteal", name = "自动杀人", value = true, toggle = true })
	Menu.Skills.R:MenuElement({id = "Targets", name = "爆发目标", type = MENU})	
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
		if hero and hero.isEnemy then
