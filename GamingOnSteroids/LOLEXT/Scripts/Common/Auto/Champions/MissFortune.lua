...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]一箭双雕", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Auto", name = "自动小兵弹跳", value = true})
	Menu.Skills.Q:MenuElement({id = "Crit", name = "需要小兵暴击", value = true})
	Menu.Skills.Q:MenuElement({id = "Hero", name = "自动2X英雄弹跳", value = true})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]大步流星", type = MENU})
	Menu.Skills.W:MenuElement({id = "Auto", name = "在走砍中使用", value = false})
	Menu.Skills.W:MenuElement({id = "Mana", name = "法力限制", value = 25, min = 5, max = 100, step = 5 })
	
	Menu.Skills:MenuElement({id = "E", name = "[E]枪林弹雨", type = MENU})
	Menu.Skills.E:MenuElement({id = "Auto", name = "攻击固定目标", value = true})
	Menu.Skills.E:MenuElement({id = "Combo", name = "走砍施放", value = true})
	Menu.Skills.E:MenuElement({id = "Count", name = "走砍目标数量", value = 2, min = 1, max = 6, step = 1})
