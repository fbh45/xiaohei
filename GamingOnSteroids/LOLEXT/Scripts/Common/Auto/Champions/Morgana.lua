...
function CreateMenu()
	...
	-- Q
	Menu.Skills:MenuElement({name = "[Q] 暗之禁锢", id = "Q", type = MENU})
	-- KS
	Menu.Skills.Q:MenuElement({name = "抢头", id = "Killsteal", type = MENU})
	Menu.Skills.Q.Killsteal:MenuElement({id = "Enabled", name = "启用", value = false})
	-- Auto
	Menu.Skills.Q:MenuElement({name = "自动", id = "Auto", type = MENU})
	Menu.Skills.Q.Auto:MenuElement({id = "Enabled", name = "启用", value = true})
	Menu.Skills.Q.Auto:MenuElement({id = "Collision", name = "跳过有小兵碰撞敌人", value = true})
	Menu.Skills.Q.Auto:MenuElement({name = "使用于：", id = "Useon", type = MENU})
	...
	Menu.Skills.Q.Auto:MenuElement({id = "Accuracy", name = "准确度", value = 3, min = 1, max = 5, step = 1})
	-- Combo / Harass
	Menu.Skills.Q:MenuElement({name = "走砍/骚扰", id = "ComHar", type = MENU})
	Menu.Skills.Q.ComHar:MenuElement({id = "Combo", name = "走砍", value = true})
	Menu.Skills.Q.ComHar:MenuElement({id = "Harass", name = "骚扰", value = false})
	Menu.Skills.Q.ComHar:MenuElement({id = "Collision", name = "跳过有小兵碰撞敌人", value = true})
	Menu.Skills.Q.ComHar:MenuElement({name = "使用于：", id = "Useon", type = MENU})
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
		if hero and hero.isEnemy then
	...
	Menu.Skills.Q.ComHar:MenuElement({id = "Accuracy", name = "准确度", value = 2, min = 1, max = 5, step = 1})

	-- W
	Menu.Skills:MenuElement({name = "[W] 折磨之影", id = "W", type = MENU})
	-- KS
	Menu.Skills.W:MenuElement({name = "抢头", id = "Killsteal", type = MENU})
	Menu.Skills.W.Killsteal:MenuElement({id = "Enabled", name = "启用", value = false})
	-- Auto
	Menu.Skills.W:MenuElement({name = "自动", id = "Auto", type = MENU})
	Menu.Skills.W.Auto:MenuElement({id = "Enabled", name = "启用", value = true})
	Menu.Skills.W.Auto:MenuElement({id = "Slow", name = "慢", value = false})
	Menu.Skills.W.Auto:MenuElement({id = "Immobile", name = "不动", value = true})
	Menu.Skills.W.Auto:MenuElement(
		{id = "Time", name = "最小毫秒", value = 500, min = 250, max = 2000, step = 50}
	)
	Menu.Skills.W.Auto:MenuElement({name = "使用于：", id = "Useon", type = MENU})
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
		if hero and hero.isEnemy then
	...
	-- Combo / Harass
	Menu.Skills.W:MenuElement({name = "走砍/骚扰", id = "ComHar", type = MENU})
	Menu.Skills.W.ComHar:MenuElement({id = "Combo", name = "使用W组合", value = true})
	Menu.Skills.W.ComHar:MenuElement({id = "Harass", name = "使用W骚扰", value = false})
	-- Clear
	Menu.Skills.W:MenuElement({name = "清线", id = "Clear", type = MENU})
	Menu.Skills.W.Clear:MenuElement({id = "Enabled", name = "启用", value = true})
	Menu.Skills.W.Clear:MenuElement({id = "Xminions", name = "W清除小兵", value = 3, min = 1, max = 5, step = 1})

	-- E
	Menu.Skills:MenuElement({name = "[E]黑暗之盾", id = "E", type = MENU})
	-- Auto
	Menu.Skills.E:MenuElement({name = "自动", id = "Auto", type = MENU})
	Menu.Skills.E.Auto:MenuElement({id = "Enabled", name = "启用", value = true})
	Menu.Skills.E.Auto:MenuElement({id = "OnCC", name = "只有传入CC使用", value = true})
	Menu.Skills.E.Auto:MenuElement({id = "Ally", name = "对盟友使用", value = true})
	Menu.Skills.E.Auto:MenuElement({id = "Selfish", name = "对自己使用", value = true})
	Menu.Skills.E.Auto:MenuElement(
		{id = "BlockDmg", name = "闵DMG阻止", value = 200, min = 0, max = 500, step = 25}
	)

	--R
	Menu.Skills:MenuElement({name = "[R]灵魂镣铐", id = "R", type = MENU})
	-- KS
	Menu.Skills.R:MenuElement({name = "抢头", id = "Killsteal", type = MENU})
	Menu.Skills.R.Killsteal:MenuElement({id = "Enabled", name = "启用", value = false})
	-- Auto
	Menu.Skills.R:MenuElement({name = "自动", id = "Auto", type = MENU})
	Menu.Skills.R.Auto:MenuElement({id = "Enabled", name = "启用", value = true})
	Menu.Skills.R.Auto:MenuElement(
		{id = "Xenemies", name = "> =附近 X敌人", value = 2, min = 1, max = 5, step = 1}
	)
	Menu.Skills.R.Auto:MenuElement(
		{id = "Xrange", name = "<X敌人距离", value = 400, min = 100, max = Q.Range, step = 25}
	)
	-- Combo / Harass
	Menu.Skills.R:MenuElement({name = "走砍/骚扰", id = "ComHar", type = MENU})
	Menu.Skills.R.ComHar:MenuElement({id = "Combo", name = "使用R组合", value = true})
	Menu.Skills.R.ComHar:MenuElement({id = "Harass", name = "使用R 骚扰", value = false})
	Menu.Skills.R.ComHar:MenuElement(
		{id = "Xenemies", name = "> =附近 X敌人", value = 2, min = 1, max = 4, step = 1}
	)
	Menu.Skills.R.ComHar:MenuElement(
		{id = "Xrange", name = "<X敌人距离", value = 400, min = 100, max = Q.Range, step = 25}
	)
