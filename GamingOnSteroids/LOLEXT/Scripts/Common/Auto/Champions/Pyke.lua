...
function LoadScript()
	...
	Menu.Skills:MenuElement({	id = "Q",	name = "[Q]透骨尖钉", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Targets", name = "拉目标", type = MENU})	
	...
	Menu.Skills.Q:MenuElement({id = "Auto", name = "自动拉", value = true	})
	Menu.Skills.Q:MenuElement({	id = "Mana",	name = "最小法力",	value = 20,	min = 1,	max = 100	})
		
	Menu.Skills:MenuElement({	id = "W",	name = "[W] 幽潭潜行",	type = MENU	})
	Menu.Skills.W:MenuElement({id = "Evade", name = "在预期时使用控制", value = true })
	Menu.Skills.W:MenuElement({id = "Combo", name = "组合中的间隙闭合", value = true })
	Menu.Skills.W:MenuElement({id = "Mana", name = "法力限制", value = 20, min = 5, max = 100, step = 5 })
		
		
	Menu.Skills:MenuElement({id = "E", name = "[E]魅影浪洄", type = MENU})
	Menu.Skills.E:MenuElement({id = "Count", name = "用于打击敌人（走砍）", value = 2, min = 1, max = 6, step = 1 })
	Menu.Skills.E:MenuElement({id = "Auto", name = "击中固定目标", value = true	})
	Menu.Skills.E:MenuElement({id = "Mana", name = "法力限制", value = 20, min = 5, max = 100, step = 5 })
	
	Menu.Skills:MenuElement({id = "R", name = "[R]涌泉之恨", type = MENU})
	Menu.Skills.R:MenuElement({id = "Count", name = "用于打击敌人（走砍）", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.R:MenuElement({id = "Killsteal", name = "斩杀", value = true })
