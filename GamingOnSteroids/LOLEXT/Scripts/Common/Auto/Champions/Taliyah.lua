...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]石穿", type = MENU})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]岩突", type = MENU})
	Menu.Skills.W:MenuElement({id = "Auto", name = "在固定自动施放", value = true})
	Menu.Skills.W:MenuElement({id = "Radius", name = "推力范围", value = 300, min = 100, max = 600, step = 50 })
	Menu.Skills.W:MenuElement({id = "Accuracy", name = "走砍精度", value = 3, min = 1, max = 6, step = 1})
	
	Menu.Skills:MenuElement({id = "E", name = "[E]撒石阵", type = MENU})
	Menu.Skills.E:MenuElement({id = "Auto", name = "在固定自动施放", value = true})
	Menu.Skills.E:MenuElement({id = "Radius", name = "剥离范围", value = 300, min = 100, max = 600, step = 50 })
	Menu.Skills.E:MenuElement({id = "Accuracy", name = "走砍精度", value = 4, min = 1, max = 6, step = 1})
