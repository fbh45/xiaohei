...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]奥能脉冲", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Assist", name = "助攻", value = true, toggle = true,  key = 0x70 })		
	Menu.Skills.Q:MenuElement({id = "Accuracy", name = "准确度", value = 3, min = 1, max = 6, step = 1 })		
	Menu.Skills.Q:MenuElement({id = "Targets", name = "目标列表", type = MENU})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]毁灭之眼", type = MENU})
	...
	Menu.Skills.W:MenuElement({id = "Killsteal", name = "斩杀", value = true, toggle = true })	
	Menu.Skills.W:MenuElement({id = "Mana", name = "最小法力", value = 20, min = 1, max = 100, step = 1 })
	
	
	Menu.Skills:MenuElement({id = "E", name = "[E]冲击法球", type = MENU})
	...
	Menu.Skills:MenuElement({id = "R", name = "[R]奥术仪式", type = MENU})
	Menu.Skills.R:MenuElement({id = "Auto", name = "自动施放", value = true })
	Menu.Skills.R:MenuElement({id = "Accuracy", name = "准确度", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.R:MenuElement({id = "Frequency", name = "施法速度", value = 1, min =.25, max = 3, step = .25 })
