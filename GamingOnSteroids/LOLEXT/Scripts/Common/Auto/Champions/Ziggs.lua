...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]弹跳炸弹", type = MENU})
	Menu.Skills.Q:MenuElement({id = "Accuracy", name = "走砍精度", value = 3, min = 1, max = 6, step = 1 })	
	Menu.Skills.Q:MenuElement({id = "KSAccuracy", name = "抢头精度", value = 2, min = 1, max = 6, step = 1 })	
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]定点爆破", type = MENU})
	Menu.Skills.W:MenuElement({id = "ComboTargets", name = "组合列表", type = MENU})
	...
	Menu.Skills.W:MenuElement({id = "Radius", name = "虚弱半径", value = 250, min = 0, max = 1000, step = 50 })

	Menu.Skills:MenuElement({id = "E", name = "[E]海克斯爆破雷区", type = MENU})
	...
	Menu.Skills.E:MenuElement({id = "Count", name = "自动施放敌人数", value = 2, min = 1, max = 6, step = 1 })	
	Menu.Skills.E:MenuElement({id = "Mana", name = "最小法力", value = 20, min = 1, max = 100, step = 1 })

	Menu.Skills:MenuElement({id = "R", name = "[R]科学的地狱火炮", type = MENU})
	Menu.Skills.R:MenuElement({id = "Targets", name = "目标列表", type = MENU})
	for i = 1, LocalGameHeroCount() do
		local hero = LocalGameHero(i)
		if hero and hero.isEnemy then
	...
	Menu.Skills.R:MenuElement({id = "Count", name = "敌人数量", value = 3, min = 1, max = 6, step = 1 })
