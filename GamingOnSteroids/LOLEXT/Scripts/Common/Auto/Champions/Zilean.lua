...
function LoadScript()
	...
	Menu.Skills:MenuElement({id = "Q", name = "[Q]定时炸弹", type = MENU})
	Menu.Skills.Q:MenuElement({id = "AccuracyCombo", name = "走砍精度", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.Q:MenuElement({id = "AccuracyAuto", name = "自动精度", value = 3, min = 1, max = 6, step = 1 })
	Menu.Skills.Q:MenuElement({id = "AccuracyStun", name = "眩晕精度", value = 2, min = 1, max = 6, step = 1 })
	Menu.Skills.Q:MenuElement({id = "Mana", name = "自动施放法力", value = 30, min = 1, max = 100, step = 5 })
	Menu.Skills.Q:MenuElement({id = "Targets", name = "目标", type = MENU})
	...
	Menu.Skills:MenuElement({id = "W", name = "[W]穿梭未来", type = MENU})
	Menu.Skills.W:MenuElement({id = "Cooldown", name = "最小冷却时间", value = 3, min = 1, max = 10, step = .5 })
	Menu.Skills.W:MenuElement({id = "Mana", name = "最小法力", value = 25, min = 1, max = 100, step = 5 })
	
	
	Menu.Skills:MenuElement({id = "E", name = "[E]时光发条", type = MENU})	
	Menu.Skills.E:MenuElement({id = "Auto", name = "自动剥离", value = true, toggle = true })
	Menu.Skills.E:MenuElement({id = "Radius", name = "虚弱半径", value = 300, min = 100, max = 600, step = 50 })
	Menu.Skills.E:MenuElement({id = "Mana", name = "最小法力", value = 25, min = 1, max = 100, step = 5 })
	
	Menu.Skills:MenuElement({id = "R", name = "[R]时光倒流", type = MENU})
