...
Saga_Menu = 
function()
	Saga = MenuElement({type = MENU, id = "Katarina", name = "佐贺的卡塔琳娜:这些坚果上的肥臀", icon = AIOIcon})
	MenuElement({ id = "blank", type = SPACE ,name = "版本3 . 1 . 2"})
	--Combo
	...
	Saga:MenuElement({id = "Killsteal", name = "偷杀", type = MENU})
    Saga.Killsteal:MenuElement({id ="qKS", name = "使用Q", value = true})
    Saga.Killsteal:MenuElement({id ="wKS", name = "使用W", value = true})
    Saga.Killsteal:MenuElement({id ="eKS", name = "使用E", value = true})

	Saga:MenuElement({id = "Misc", name = "R设置", type = MENU})
	Saga.Misc:MenuElement({id = "UseR", name = "R", value = true})
	Saga.Misc:MenuElement({id = "RCount", name = "在X目标上使用R", value = 3, min = 1, max = 5, step = 1})
    
    Saga:MenuElement({id = "Rate", name = "调整率", type = MENU})
	Saga.Rate:MenuElement({id = "champion", name = "值", value = 30, min = 1, max = 120, step = 1})

    Saga:MenuElement({id = "Escape", name = "运行忍者模式(逃离)", type = MENU})
    Saga.Escape:MenuElement({id = "UseW", name = "W", value = true})
    Saga.Escape:MenuElement({id = "UseE", name = "E", value = true})

    Saga:MenuElement({id = "Dagger", name = "匕首设置", type = MENU})
    Saga.Dagger:MenuElement({id = "EDagger", name = "只E匕首", value = false})
    Saga.Dagger:MenuElement({id = "MDagger", name = "移动到匕首", value = false})
    Saga.Dagger:MenuElement({id = "MLDagger", name = "移动最大匕首射程", value = false})

    Saga:MenuElement({id = "Zhonya", name = "使用中亚", type = MENU})
    Saga.Zhonya:MenuElement({id = "UseZ", name = "中亚", value = true})
    ...
    Saga:MenuElement({id = "TS", name = "目标选择器", type = MENU})
    Saga.TS:MenuElement({id = "cTS", name = "内置目标选择器", value = true, tooltip = "If off it uses orbwalkers"})
    ...
    Saga.Drawings.Q:MenuElement({id = "Color", name = "颜色", color = Draw.Color(200, 255, 255, 255)})
        --E
    Saga.Drawings:MenuElement({id = "E", name = "绘制E范围", type = MENU})
