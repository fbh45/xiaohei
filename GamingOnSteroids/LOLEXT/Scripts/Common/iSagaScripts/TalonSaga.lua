...
local isEvading = ExtLibEvade and ExtLibEvade.Evading
	local validTarget,
        ...
        SpellData = {
            ["Aatrox"] = {
                ["aatroxeconemissile"] = {name = "折磨之刃",radius =  35}
            },
            ["Ahri"] = {
                ["ahriorbmissile"] = { name = "欺骗之球", radius =  100 },
                ["ahrifoxfiremissiletwo"] = {name = "狐狸火", Width =  50},
                ["ahriseducemissile"] = {name = "魅力", radius =  60},
                ["ahritumblemissile"] = { name  = "SpiritRush", radius =  600}
            },
            ["Akali"] = {
                ["akalimota"] = {name = "阿萨辛的标志", radius =  600}
            },
            ["Amumu"] = {
                ["sadmummybandagetoss"] = { name = "投掷绷带", Width =  50}
            },
            ["Anivia"] = {
                ["flashfrostspell"] = { name = "闪光霜", radius =  110},
                ["frostbite"] = { name = "冻伤", radius =  650}
            },
            ["Annie"] = {
                ["disintegrate"] = { name = "瓦解", radius =  710}
            },
            ["Ashe"] = {
                ["volleyattack"] = {name = "齐射", Width =  50},
                ["enchantedcrystalarrow"] = { name = "魔晶箭", Radius =  130}
            },
            ["AurelionSol"] = {
                ["aurelionsolqmissile"] = { name = "红蜘蛛", radius =  50}
            },
            ["Bard"] = {
                ["bardqmissile"] = { name = "宇宙束缚", Width =  50}
            },
            ["Blitzcrank"] = {
                ["rocketgrabmissile"] = { name = "火箭抓斗", radius =  70}
            },
            ["Brand"] = {
                ["brandqmissile"] = { name = "Sear", Width =  50},
                ["brandr"] = { name = "火山碎屑", radius =  600}
            },
            ["Braum"] = {
                ["braumqmissile"] = { name = "冬天的咬", radius =  60},
                ["braumrmissile"] = { name = "冰川裂缝", radius =  115}
            },
            ["Caitlyn"] = {
                ["caitlynpiltoverpeacemaker"] = { name = "皮尔托夫和事佬", radius =  90},
                ["caitlynaceintheholemissile"] = { name = "最后王牌", radius =  50}
            },
            ["Cassiopeia"] = {
                ["cassiopeiatwinfang"] = {name = "孪生芳", radius =  0}
            },
            ["Corki"] = {
                ["phosphorusbombmissile"] = { name = "磷弹", radius =  250},
                ["missilebarragemissile"] = { name = "导弹拦河坝", Width =  40},
                ["missilebarragemissile2"] = { name = "大型导弹火力网", Width =  40}
            },
            ["Diana"] = {
                ["dianaarcthrow"] = { name = "新月罢工", radius =  50}
            },
            ["DrMundo"] = {
                ["infectedcleavermissile"] = { name = "受感染的切肉刀", Width =  50}
            },
            ["Draven"] = {
                ["dravenr"] = { name = "旋转死亡", radius =  160}
            },
            ["Ekko"] = {
                ["ekkoqmis"] = { name = "时光机", radius =  50}
            },
            ["Elise"] = {
                ["elisehumanq"] = { name = "神经毒素", radius =  50},
                ["elisehumane"] = { name = "Cocoon", radius =  55}
            },
            ["Ezreal"] = {
                ["ezrealmysticshotmissile"] = { name = "神秘镜头", radius =  60},
                ["ezrealessencefluxmissile"] = {name = "精通量", radius =  80},
                ["ezrealarcaneshiftmissile"] = { name = "奥术移位", radius =  275},
                ["ezrealtrueshotbarrage"] = { name = "强击机火力网", radius =  160}
            },
            ["FiddleSticks"] = {
                ["fiddlesticksdarkwindmissile"] = { name = "阴风", radius =  50}
            },
            ["Gangplank"] = {
                ["parley"] = { name = "谈判", radius =  50}
            },
            ["Gnar"] = {
                ["gnarqmissile"] = { name = "回旋镖投掷", Width =  50},
                ["gnarbigqmissile"] = { name = "掷石", Width =  50}
            },
            ["Gragas"] = {
                ["gragasqmissile"] = { name = "滚桶", Width =  50},
                ["gragasrboom"] = { name = "爆炸桶", Width =  50}
            },
            ["Graves"] = {
                ["gravesqlinemis"] = { name = "线的尽头", radius =  60},
                ["graveschargeshotshot"] = { name = "附带损害", radius =  100}
            },
            ["Illaoi"] = {
                ["illaoiemis"] = { name = "精神测验", radius =  50}
            },
            ["Irelia"] = {
                ["IreliaTranscendentBlades"] = { name = "超验刀片", radius =  120}
            },
            ["Janna"] = {
                ["howlinggalespell"] = { name = "呼啸大风", Width =  120},
                ["sowthewind"] = {name = "和风", radius =  50}
            },
            ["Jayce"] = {
                ["jayceshockblastmis"] = { name = "冲击波", radius =  70},
                ["jayceshockblastwallmis"] = { name = "增强冲击波", radius =  70}
            },
            ["Camille"] = {
                ["Camillewmissile"] = {name = "Zap!", radius =  50},
                ["Camiller"] = { name = "超级巨型死亡火箭！", Width =  50}
            },
            ["Jhin"] = {
                ["jhinwmissile"] = {name = "致命的繁荣", radius =  40},
                ["jhinrshotmis"] = { name = "谢幕", radius =  80}
            },
            ["Kalista"] = {
                ["kalistamysticshotmis"] = { name = "进入", radius =  40}
            },
            ["Karma"] = {
                ["karmaqmissile"] = { name = "内层焰", radius =  60},
                ["karmaqmissilemantra"] = { name = "咒语:内在火焰", Width =  50}
            },
            ["Kassadin"] = {
                ["nulllance"] = { name = "零球", radius =  50}
            },
            ["Katarina"] = {
                ["katarinaqmis"] = { name = "弹跳叶片", Width =  50}
            },
            ["Kayle"] = {
                ["judicatorreckoning"] = { name = "计算", Width =  50}
            },
            ["Kennen"] = {
                ["kennenshurikenhurlmissile1"] = { name = "雷鸣般的舒里肯", radius =  50}
            },
            ["Khazix"] = {
                ["khazixwmissile"] = {name = "空隙钉", Width =  50}
            },
            ["Kogmaw"] = {
                ["kogmawq"] = { name = "腐蚀性痰液", radius =  70},
                ["kogmawvoidoozemissile"] = { name = "空隙渗水", Width =  50},
            },
            ["Leblanc"] = {
                ["leblancchaosorbm"] = { name = "粉碎球", radius =  50},
                ["leblancsoulshackle"] = { name = "醚链", Width =  50},
                ["leblancsoulshacklem"] = { name = "醚链克隆", Width =  50}
            },
            ["LeeSin"] = {
                ["blindmonkqone"] = { name = "声波", Width =  65}
            },
            ["Leona"] = {
                ["LeonaZenithBladeMissile"] = { name = "天顶叶片", Width =  50}
            },
            ["Lissandra"] = {
                ["lissandraqmissile"] = { name = "冰块碎片", Width =  50},
                ["lissandraemissile"] = { name = "冰川路径", Width =  50}
            },
            ["Lucian"] = {
                ["lucianwmissile"] = {slot = 1, danger = 1, name = "炽热的火焰", radius =  55},
                ["lucianrmissileoffhand"] = { name = "剔除", radius =  110}
            },
            ["Lulu"] = {
                ["luluqmissile"] = { name = "闪光枪", Width =  50}
            },
            ["Lux"] = {
                ["luxlightbindingmis"] = { name = "", Width =  50} 
            },
            ["Malphite"] = {
                ["seismicshard"] = { name = "地震碎片", radius =  50}
            },
            ["MissFortune"] = {
                ["missfortunericochetshot"] = { name = "加倍", radius =  250}
            },
            ["Morgana"] = {
                ["darkbindingmissile"] = { name = "暗结合", radius =  80}
            },
            ["Nami"] = {
                ["namiwmissileenemy"] = {name = "消长", radius =  50}
            },
            ["Nunu"] = {
                ["iceblast"] = { name = "冰爆", radius =  50}
            },
            ["Nautilus"] = {
                ["nautilusanchordragmissile"] = { name = "", Width =  90}
            },
            ["Nidalee"] = {
                ["JavelinToss"] = { name = "掷标枪", radius =  40}
            },
            ["Nocturne"] = {
                ["nocturneduskbringer"] = { name = "昏暗的铃声", radius =  60}
            },
            ["Pantheon"] = {
                ["pantheonq"] = { name = "长矛射击", radius =  50}
            },
            ["RekSai"] = {
                ["reksaiqburrowedmis"] = { name = "猎物搜寻者", radius =  60}
            },
            ["Rengar"] = {
                ["rengarefinal"] = { name = "波拉罢工", Width =  50}
            },
            ["Riven"] = {
                ["rivenlightsabermissile"] = { name = "风斜线", radius =  125}
            },
            ["Rumble"] = {
                ["rumblegrenade"] = {name = "电鱼叉", Width =  50}
            },
            ["Ryze"] = {
                ["ryzeq"] = { name = "过多", radius =  50},
                ["ryzee"] = {name = "咒语通量", radius =  50}
            },
            ["Sejuani"] = {
                ["sejuaniglacialprison"] = { name = "冰川监狱", Width =  50}
            },
            ["Sivir"] = {
                ["sivirqmissile"] = { name = "回旋镖刀片", radius =  90}
            },
            ["Skarner"] = {
                ["skarnerfracturemissile"] = { name = "破裂", Width =  50}
            },
            ["Shaco"] = {
                ["twoshivpoison"] = { name = "双屑毒药", Width =  50}
            },
            ["Sona"] = {
                ["sonaqmissile"] = { name = "英勇赞歌", radius =  50},
                ["sonar"] = { name = "声音渐增", radius =  140}
            },
            ["Swain"] = {
                ["swaintorment"] = { name = "痛苦", radius =  50}
            },
            ["Syndra"] = {
                ["syndrarspell"] = { name = "释放的力量", radius =  50}
            },
            ["Teemo"] = {
                ["blindingdart"] = { name = "致盲镖", radius =  50}
            },
            ["Tristana"] = {
                ["detonatingshot"] = { name = "爆炸装药", radius =  50}
            },
            ["TahmKench"] = {
                ["tahmkenchqmissile"] = { name = "舌鞭", radius =  70}
            },
            ["Taliyah"] = {
                ["taliyahqmis"] = { name = "螺纹截击", radius =  100}
            },
            ["Talon"] = {
                ["talonrakemissileone"] = {name = "Rake", Width =  50}
            },
            ["TwistedFate"] = {
                ["bluecardpreattack"] = {name = "蓝色卡片", radius =  50},
                ["goldcardpreattack"] = {name = "金卡", radius =  50},
                ["redcardpreattack"] = {name = "红牌", radius =  50}
            },
            ["Urgot"] = {
                --
            },
            ["Varus"] = {
                ["varusqmissile"] = { name = "穿心箭", radius =  70},
                ["varusrmissile"] = { name = "腐败链", Width =  50}
            },
            ["Vayne"] = {
                ["vaynecondemnmissile"] = { name = "谴责", Width =  50}
            },
            ["Veigar"] = {
                ["veigarbalefulstrikemis"] = { name = "恶意罢工", radius =  70},
                ["veigarr"] = { name = "原始爆发", Width =  50}
            },
            ["Velkoz"] = {
                ["velkozqmissile"] = { name = "等离子体裂变", Width =  50},
                ["velkozqmissilesplit"] = { name = "等离子体裂变分裂", radius =  50}
             },
            ["Viktor"] = {
                ["viktorpowertransfer"] = { name = "虹吸动力", radius =  50},
                ["viktordeathraymissile"] = { name = "死光", radius =  80}
            },
            ["Vladimir"] = {
                ["vladimirtidesofbloodnuke"] = { name = "血潮", radius =  50}
            },
            ["Camille"] = {
                ["Camilleq3wmis"] = { name = "聚集风暴", radius =  50}
            },
            ["Zed"] = {
                ["zedqmissile"] = { name = "剃刀舒里肯", radius =  50}
            },
            ["Zyra"] = {
                ["zyrae"] = { name = "抓住根", Width =  50}
            }
        }
    ...
    for i = 1, TotalHeroes do 
        ...
        if SpellData[unit.charName] then
            for x, v in pairs(SpellData[unit.charName]) do
                if v then
    Saga.Wset.UseW:MenuElement({id = x, name = "使用W："..v['name'], value = true})
                end
            end
        end
    end
...
LocalCallbackAdd("Tick", function()
    ...
    Saga_Menu = 
    function()
        Saga = MenuElement({type = MENU, id = "Talon", name = "saga的魔爪:生死在刀锋下", icon = AIOIcon})
        MenuElement({ id = "blank", type = SPACE ,name = "版本BETA 1 . 2 . 3"})
        --Combo
        Saga:MenuElement({id = "Combo", name = "走砍", type = MENU})
        Saga.Combo:MenuElement({id = "UseQ", name = "Q", value = true})
        Saga.Combo:MenuElement({id = "UseW", name = "W", value = true})
        Saga.Combo:MenuElement({id = "UseR", name = "R", value = true})
        Saga.Combo:MenuElement({id = "blank2", name = "只选择其中之一(最好)",type = SPACE})
        Saga.Combo:MenuElement({id = "UseC", name = "连招1", value = false})
        Saga.Combo:MenuElement({id = "UseL", name = "连招2", value = true})

        Saga:MenuElement({id = "Harass", name = "骚扰", type = MENU})
        Saga.Harass:MenuElement({id = "UseQ", name = "Q", value = true})
        Saga.Harass:MenuElement({id = "UseW", name = "W", value = true})
        
    
        
        Saga:MenuElement({id = "Clear", name = "清线", type = MENU})
        Saga.Clear:MenuElement({id = "UseQ", name = "Q", value = true})
        Saga.Clear:MenuElement({id = "UseW", name = "W", value = true})
        
    
        
        Saga:MenuElement({id = "Rate", name = "调整率", type = MENU})
        Saga.Rate:MenuElement({id = "champion", name = "值", value = 30, min = 1, max = 120, step = 1})
        
        Saga:MenuElement({id = "KillSteal", name = "斩杀", type = MENU})
        ...
        Saga:MenuElement({id = "items", name = "使用物品", type = MENU})
        Saga.items:MenuElement({id = "bg", name = "使用 比尔吉沃特弯刀/破板王者之刃", value = true})
        Saga.items:MenuElement({id = "tm", name = "提亚马特/贪欲九头蛇", value = true})
        Saga.items:MenuElement({id = "yg", name = "幽梦之灵", value = true})
        Saga.items:MenuElement({id = "ig", name = "点燃", value = true})
    
        Saga:MenuElement({id = "Drawings", name = "图纸", type = MENU})
        Saga.Drawings:MenuElement({id = "Q", name = "绘制Q范围", type = MENU})
        Saga.Drawings.Q:MenuElement({id = "Enabled", name = "启用", value = true})       
        Saga.Drawings.Q:MenuElement({id = "Width", name = "宽度", value = 1, min = 1, max = 5, step = 1})
        Saga.Drawings.Q:MenuElement({id = "Color", name = "颜色", color = Draw.Color(200, 255, 255, 255)})
            --E
            Saga.Drawings:MenuElement({id = "W", name = "绘制W范围", type = MENU})
            Saga.Drawings.W:MenuElement({id = "Enabled", name = "启用", value = true})       
            Saga.Drawings.W:MenuElement({id = "Width", name = "宽度", value = 1, min = 1, max = 5, step = 1})
            Saga.Drawings.W:MenuElement({id = "Color", name = "颜色", color = Draw.Color(200, 255, 255, 255)})
        
        
        Saga.Drawings:MenuElement({id = "R", name = "绘制R范围", type = MENU})
        Saga.Drawings.R:MenuElement({id = "Enabled", name = "启用", value = true})       
        Saga.Drawings.R:MenuElement({id = "Width", name = "宽度", value = 1, min = 1, max = 5, step = 1})
        Saga.Drawings.R:MenuElement({id = "Color", name = "颜色", color = Draw.Color(200, 255, 255, 255)})	
