...
function Menu:Init
    ()
    self.Main = MenuElement({id = 'GSOProject', name = '走砍设置', type = MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/rsz_gsoorbwalker.png"})
    
    self.Target = self.Main:MenuElement({id = 'Target', name = '目标选择器', type = MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/ts.png"})
    self.Target:MenuElement({id = 'Priorities', name = '优先级', type = MENU})
    self.Target:MenuElement({id = 'SelectedTarget', name = '选定目标', value = true})
    self.Target:MenuElement({id = 'OnlySelectedTarget', name = '仅选定目标', value = false})
    self.Target:MenuElement({id = 'SortMode' .. myHero.charName, name = '排序模式', value = 1, drop = {'Auto', 'Closest', 'Near Mouse', 'Lowest HP', 'Lowest MaxHP', 'Highest Priority', 'Most Stack', 'Most AD', 'Most AP', 'Less Cast', 'Less Attack'}})
    
    self.Orbwalker = self.Main:MenuElement({id = 'Orbwalker', name = '走砍', type = MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/orb.png"})
    self.Orbwalker:MenuElement({id = 'Keys', name = '按键', type = MENU})
    self.Orbwalker.Keys:MenuElement({id = 'Combo', name = '走砍键', key = string.byte(' ')})
    self.Orbwalker.Keys:MenuElement({id = 'Harass', name = '骚扰键', key = string.byte('C')})
    self.Orbwalker.Keys:MenuElement({id = 'LastHit', name = '最后一击键', key = string.byte('X')})
    self.Orbwalker.Keys:MenuElement({id = 'LaneClear', name = '清线键', key = string.byte('V')})
    self.Orbwalker.Keys:MenuElement({id = 'Jungle', name = '清野键', key = string.byte('V')})
    self.Orbwalker.Keys:MenuElement({id = 'Flee', name = '逃离键', key = string.byte('A')})
    self.Orbwalker.Keys:MenuElement({id = 'HoldKey', name = '保持键', key = string.byte('H'), tooltip = 'Should be same in game keybinds'})
    self.Orbwalker:MenuElement({id = 'General', name = '一般', type = MENU})
    self.Orbwalker.General:MenuElement({id = 'AttackTargetKeyUse', name = '攻击目标键使用', value = true})
    self.Orbwalker.General:MenuElement({id = 'AttackTKey', name = '快捷指定攻击键', key = string.byte('U'), tooltip = 'You should bind this one in ingame settings'})
    self.Orbwalker.General:MenuElement({id = 'AttackResetting', name = '攻击重置', value = true})
    self.Orbwalker.General:MenuElement({id = 'FastKiting', name = '快速的风筝', value = true})
    self.Orbwalker.General:MenuElement({id = 'LaneClearHeroes', name = '线上清除英雄', value = true})
    self.Orbwalker.General:MenuElement({id = 'StickToTarget', name = '坚持目标：只有近战', value = true})
    self.Orbwalker.General:MenuElement({id = 'SkipTargets', name = '移动目标', value = true})
    self.Orbwalker.General:MenuElement({id = 'MovementDelay', name = '运动延迟', value = 250, min = 0, max = 1000, step = 25})
    self.Orbwalker.General:MenuElement({id = 'HoldRadius', name = '保持半径', value = 0, min = 0, max = 250, step = 10})
    self.Orbwalker.General:MenuElement({id = 'ExtraWindUpTime', name = '额外结束时间', value = 0, min = -25, max = 75, step = 5})
    self.Orbwalker:MenuElement({id = 'RandomHumanizer', name = '鼠标点击频率', type = MENU})
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Min', name = '最小', value = 160, min = 0, max = 300, step = 10})
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Max', name = '最大', value = 240, min = 0, max = 400, step = 10})
    ...
    self.Main:MenuElement({id = 'Items', name = '项目', type = MENU, leftIcon = "https://vignette.wikia.nocookie.net/leagueoflegends/images/a/aa/Ace_in_the_Hole.png"})
    self.Main.Items:MenuElement({id = 'Qss', name = '水银饰带', type = MENU})
    self.Main.Items.Qss:MenuElement({id = 'BuffTypes', name = 'Buff 类型', type = MENU})
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Slow', name = '减速 内瑟斯 w', value = true})--SLOW = 10 -> nasus W, zilean E
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Stun', name = '眩晕 娑娜 r', value = true})--STUN = 5
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Snare', name = '倒钩 霞 e', value = true})--SNARE = 11
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Supress', name = '压制 沃里克 r', value = true})--SUPRESS = 24
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Knockup', name = '击飞 亚索 q3', value = true})--KNOCKUP = 29
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Fear', name = '恐惧 费德提克 q', value = true})--FEAR = 21 -> fiddle Q, ...
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Charm', name = '魅惑 阿狸 e', value = true})--CHARM = 22 -> ahri E, ...
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Taunt', name = '嘲讽 拉莫斯 e', value = true})--TAUNT = 8 -> rammus E, ...
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Knockback', name = '击退 阿利斯塔 w', value = true})--KNOCKBACK = 30 -> alistar W, lee sin R, ...
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Blind', name = '致盲 提莫 q', value = true})--BLIND = 25 -> teemo Q
    self.Main.Items.Qss.BuffTypes:MenuElement({id = 'Disarm', name = '变形 璐璐 w', value = true})--DISARM = 31 -> Lulu W
    self.Main.Items.Qss:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Main.Items.Qss:MenuElement({id = 'Count', name = '敌人数', value = 1, min = 0, max = 5, step = 1})
    self.Main.Items.Qss:MenuElement({id = 'Distance', name = '敌人距离<X', value = 1200, min = 0, max = 1500, step = 50})
    self.Main.Items.Qss:MenuElement({id = 'Duration', name = 'Buff持续时间> X', value = 500, min = 0, max = 1000, step = 50})
    self.Main.Items:MenuElement({id = 'Botrk', name = '破败王者之刃', type = MENU})
    self.Main.Items.Botrk:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Main.Items.Botrk:MenuElement({id = 'AntiMelee', name = '反战', value = true})
    self.Main.Items.Botrk:MenuElement({id = 'HeroHealth', name = '英雄健康％<X', value = 50, min = 0, max = 100, step = 1})
    self.Main.Items.Botrk:MenuElement({id = 'TargetDistance', name = '目标距离<X', value = 0, min = 0, max = 650, step = 10})
    self.Main.Items.Botrk:MenuElement({id = 'FleeRange', name = '逃离目标距离> X', value = 550, min = 300, max = 600, step = 10})
    self.Main.Items.Botrk:MenuElement({id = 'FleeHealth', name = '逃离目标健康％<X', value = 50, min = 0, max = 100, step = 1})
    self.Main.Items:MenuElement({id = 'HexGun', name = '海克斯科技枪刃', type = MENU})
    self.Main.Items.HexGun:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Main.Items.HexGun:MenuElement({id = 'AntiMelee', name = '反战', value = true})
    self.Main.Items.HexGun:MenuElement({id = 'HeroHealth', name = '英雄健康％<X', value = 50, min = 0, max = 100, step = 1})
    self.Main.Items.HexGun:MenuElement({id = 'TargetDistance', name = '目标距离<X', value = 300, min = 0, max = 700, step = 10})
    self.Main.Items.HexGun:MenuElement({id = 'FleeRange', name = '逃离目标距离> X', value = 550, min = 300, max = 600, step = 10})
    self.Main.Items.HexGun:MenuElement({id = 'FleeHealth', name = '逃离目标健康％<X', value = 50, min = 0, max = 100, step = 1})
    
    self.Main:MenuElement({id = 'Drawings', name = '图纸', type = MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/circles.png"})
    self.Main.Drawings:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Main.Drawings:MenuElement({id = 'Cursor', name = '光标', value = true})
    self.Main.Drawings:MenuElement({id = 'Range', name = '自动攻击范围', value = true})
    self.Main.Drawings:MenuElement({id = 'EnemyRange', name = '敌人自动攻击范围', value = true})
    self.Main.Drawings:MenuElement({id = 'HoldRadius', name = '保持半径', value = false})
    self.Main.Drawings:MenuElement({id = 'LastHittableMinions', name = '最后一个被攻击的小兵', value = true})
    self.Main.Drawings:MenuElement({id = 'SelectedTarget', name = '选定目标', value = true})
    
    self.Main:MenuElement({name = '', type = _G.SPACE, id = 'GeneralSpace'})
    self.Main:MenuElement({id = 'Latency', name = '延迟', value = 30, min = 0, max = 120, step = 5, callback = function(value) _G.LATENCY = value end})
    self.Main:MenuElement({id = 'CursorDelay', name = '光标延迟', value = 30, min = 0, max = 50, step = 5})
