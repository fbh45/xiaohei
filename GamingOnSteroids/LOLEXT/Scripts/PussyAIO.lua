...
function Ahri:LoadMenu()
	--MainMenu
	self.Menu = MenuElement({type = MENU, id = "Ahri", name = "Pussy 阿狸", leftIcon = HeroIcon})
	--ComboMenu
...
Type = _G.SPELLTYPE_CONE, Delay = 0.5, Radius = 80, Range = 825, Speed = 3200, Collision = false
	...
	function Cassiopeia:Menu()
		Cass = MenuElement({type = MENU, id = "Cass", name = "Pussy卡西奥佩娅"})		
...
function Zyra:LoadMenu()                     
	--MainMenu
	self.Menu = MenuElement({type = MENU, id = "Zyra", name = "Pussy婕拉"})
