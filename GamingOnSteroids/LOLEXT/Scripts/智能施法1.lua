...
function Twitch:CreateMenu()
    Menu = MenuElement({name = "图奇", id = "Gamsteron_Twitch", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/twitch.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    Menu.qset:MenuElement({id = "combo", name = "走砍使用Q", value = false})
    Menu.qset:MenuElement({id = "harass", name = "使用Q骚扰", value = false})
    Menu.qset:MenuElement({id = "recallkey", name = "隐形召回钥匙", key = string.byte("T"), value = false, toggle = true})
    Menu.qset.recallkey:Value(false)
    Menu.qset:MenuElement({id = "note1", name = "注意：键应与召回键不同", type = SPACE})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    Menu.wset:MenuElement({id = "stopq", name = "如果Q不可见则停止", value = true})
    Menu.wset:MenuElement({id = "stopwult", name = "如果R停止", value = false})
    Menu.wset:MenuElement({id = "combo", name = "使用W Combo", value = true})
    Menu.wset:MenuElement({id = "harass", name = "使用W骚扰", value = false})
    Menu.wset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- E
    Menu:MenuElement({name = "E设置", id = "eset", type = _G.MENU})
    Menu.eset:MenuElement({id = "combo", name = "走砍使用E", value = true})
    Menu.eset:MenuElement({id = "harass", name = "骚扰使用E", value = false})
    Menu.eset:MenuElement({id = "killsteal", name = "使用E KS", value = true})
    Menu.eset:MenuElement({id = "stacks", name = "X堆栈", value = 6, min = 1, max = 6, step = 1})
    Menu.eset:MenuElement({id = "enemies", name = "X敌人", value = 1, min = 1, max = 5, step = 1})
    -- R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    Menu.rset:MenuElement({id = "combo", name = "使用R Combo", value = true})
    Menu.rset:MenuElement({id = "harass", name = "使用R 骚扰", value = false})
    Menu.rset:MenuElement({id = "xenemies", name = "x  - 敌人", value = 3, min = 1, max = 5, step = 1})
    Menu.rset:MenuElement({id = "xrange", name = "x  - 距离", value = 750, min = 300, max = 1500, step = 50})
    -- Drawings
    Menu:MenuElement({name = "图纸", id = "draws", type = _G.MENU})
    Menu.draws:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.draws:MenuElement({name = "Q计时器", id = "qtimer", type = _G.MENU})
    Menu.draws.qtimer:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.draws.qtimer:MenuElement({id = "color", name = "颜色", color = Draw.Color(200, 65, 255, 100)})
    Menu.draws:MenuElement({name = "Q隐形范围", id = "qinvisible", type = _G.MENU})
    Menu.draws.qinvisible:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.draws.qinvisible:MenuElement({id = "color", name = "颜色", color = Draw.Color(200, 255, 0, 0)})
    Menu.draws:MenuElement({name = "Q通知范围", id = "qnotification", type = _G.MENU})
    Menu.draws.qnotification:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.draws.qnotification:MenuElement({id = "color", name = "颜色", color = Draw.Color(200, 188, 77, 26)})
end
...
function Morgana:CreateMenu()
    Menu = MenuElement({name = "莫甘娜", id = "Gamsteron_Morgana", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/morganads83fd.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    -- Disable Attack
    Menu.qset:MenuElement({id = "disaa", name = "如果准备好或几乎准备就禁用攻击", value = false})
    -- Interrupt:
    Menu.qset:MenuElement({id = "interrupter", name = "断续器", value = true})
    -- KS
    Menu.qset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    Menu.qset.killsteal:MenuElement({id = "enabled", name = "启用", value = false})
    Menu.qset.killsteal:MenuElement({id = "minhp", name = "最小的敌人生命值", value = 200, min = 1, max = 300, step = 1})
    Menu.qset.killsteal:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"Normal", "High", "Immobile"}})
    -- Auto
    Menu.qset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.qset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.qset.auto:MenuElement({name = "用于：", id = "useon", type = _G.MENU})
    ...
    Menu.qset.auto:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"Normal", "High", "Immobile"}})
    -- Combo / Harass
    Menu.qset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.qset.comhar:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset.comhar:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.qset.comhar:MenuElement({name = "用于：", id = "useon", type = _G.MENU})
    ...
    Menu.qset.comhar:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"Normal", "High", "Immobile"}})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    -- KS
    Menu.wset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    Menu.wset.killsteal:MenuElement({id = "enabled", name = "启用", value = false})
    Menu.wset.killsteal:MenuElement({id = "minhp", name = "最小的敌人生命值", value = 200, min = 1, max = 300, step = 1})
    -- Auto
    Menu.wset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.wset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    -- Combo / Harass
    Menu.wset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.wset.comhar:MenuElement({id = "combo", name = "使用W Combo", value = false})
    Menu.wset.comhar:MenuElement({id = "harass", name = "使用W骚扰", value = false})
    -- Clear
    Menu.wset:MenuElement({name = "清线", id = "laneclear", type = _G.MENU})
    Menu.wset.laneclear:MenuElement({id = "enabled", name = "启用", value = false})
    ...
    Menu.eset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.eset.auto:MenuElement({id = "ally", name = "用在盟友身上", value = true})
    Menu.eset.auto:MenuElement({id = "selfish", name = "使用自己", value = true})
    --R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    -- KS
    Menu.rset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    Menu.rset.killsteal:MenuElement({id = "enabled", name = "启用", value = false})
    Menu.rset.killsteal:MenuElement({id = "minhp", name = "最小的敌人生命值", value = 200, min = 1, max = 300, step = 1})
    -- Auto
    Menu.rset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.rset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.rset.auto:MenuElement({id = "xenemies", name = "> = morgana附近的X敌人", value = 3, min = 1, max = 5, step = 1})
    Menu.rset.auto:MenuElement({id = "xrange", name = "<X距离敌人到morgana", value = 300, min = 100, max = 550, step = 50})
    -- Combo / Harass
    Menu.rset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.rset.comhar:MenuElement({id = "combo", name = "使用R Combo", value = true})
    Menu.rset.comhar:MenuElement({id = "harass", name = "使用R 骚扰", value = false})
    Menu.rset.comhar:MenuElement({id = "xenemies", name = "> = morgana附近的X敌人", value = 2, min = 1, max = 4, step = 1})
    Menu.rset.comhar:MenuElement({id = "xrange", name = "<X距离敌人到morgana", value = 300, min = 100, max = 550, step = 50})
end
...
function Karthus:CreateMenu()
    Menu = MenuElement({name = "卡尔萨斯", id = "Gamsteron_Karthus", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/karthusw5s.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    -- Disable Attack
    Menu.qset:MenuElement({id = "disaa", name = "禁用攻击", value = true})
    -- KS
    Menu.qset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    Menu.qset.killsteal:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.qset.killsteal:MenuElement({id = "minhp", name = "最小的敌人生命值", value = 200, min = 1, max = 300, step = 1})
    Menu.qset.killsteal:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- Auto
    Menu.qset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.qset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.qset.auto:MenuElement({name = "用于：", id = "useon", type = _G.MENU})
    SDKObject:OnEnemyHeroLoad(function(args) Menu.qset.auto.useon:MenuElement({id = args.CharName, name = args.CharName, value = true}) end)
    Menu.qset.auto:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- Combo / Harass
    Menu.qset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.qset.comhar:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset.comhar:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.qset.comhar:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    Menu.wset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.wset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.wset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- E
    Menu:MenuElement({name = "E设置", id = "eset", type = _G.MENU})
    Menu.eset:MenuElement({id = "auto", name = "Auto", value = true})
    Menu.eset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.eset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.eset:MenuElement({id = "minmp", name = "最低法力值", value = 25, min = 1, max = 100, step = 1})
    --R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    Menu.rset:MenuElement({id = "killsteal", name = "自动KS X被动形式的敌人", value = true})
    Menu.rset:MenuElement({id = "kscount", name = "^^^ X敌人^^^", value = 2, min = 1, max = 5, step = 1})
    -- Drawings
    Menu:MenuElement({name = "图纸", id = "draws", type = _G.MENU})
    Menu.draws:MenuElement({name = "画杀数", id = "ksdraw", type = _G.MENU})
    Menu.draws.ksdraw:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.draws.ksdraw:MenuElement({id = "size", name = "字体大小", value = 25, min = 1, max = 64, step = 1})
end
...
function KogMaw:CreateMenu()
    Menu = MenuElement({name = "克格莫", id = "Gamsteron_KogMaw", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/kog.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    Menu.qset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.qset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    Menu.wset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.wset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.wset:MenuElement({id = "stopq", name = "如果有W buff则停止Q.", value = false})
    Menu.wset:MenuElement({id = "stope", name = "如果有W buff则停止E.", value = false})
    Menu.wset:MenuElement({id = "stopr", name = "如果有W buff则停止R.", value = false})
    -- E
    Menu:MenuElement({name = "E设置", id = "eset", type = _G.MENU})
    Menu.eset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.eset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.eset:MenuElement({id = "emana", name = "", value = 20, min = 1, max = 100, step = 1})
    Menu.eset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    Menu.rset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.rset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.rset:MenuElement({id = "onlylow", name = "只有0-40％的HP敌人", value = true})
    Menu.rset:MenuElement({id = "stack", name = "停在x堆栈", value = 3, min = 1, max = 9, step = 1})
    Menu.rset:MenuElement({id = "rmana", name = "", value = 20, min = 1, max = 100, step = 1})
    Menu.rset:MenuElement({name = "KS", id = "ksmenu", type = _G.MENU})
    Menu.rset.ksmenu:MenuElement({id = "ksr", name = "KS  - 已启用", value = true})
    Menu.rset.ksmenu:MenuElement({id = "csksr", name = "KS  - >检查R堆栈", value = false})
    Menu.rset:MenuElement({name = "半手动", id = "semirkog", type = _G.MENU})
    Menu.rset.semirkog:MenuElement({name = "半手动键", id = "semir", key = string.byte("T")})
    Menu.rset.semirkog:MenuElement({name = "检查R堆栈", id = "semistacks", value = false})
    Menu.rset.semirkog:MenuElement({name = "只有0-40％的HP敌人", id = "semilow", value = false})
    Menu.rset.semirkog:MenuElement({name = "用于：", id = "useon", type = _G.MENU})
    ...
    Menu.rset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
end
...
function Vayne:CreateMenu()
    Menu = MenuElement({name = "薇恩", id = "Gamsteron_Vayne", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/vayne.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    Menu.qset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset:MenuElement({id = "harass", name = "骚扰", value = false})
    ...
    Menu.eset:MenuElement({name = "使用（AntiMelee）：", id = "useonmelee", type = _G.MENU})
    ...
    Menu.eset:MenuElement({id = "interrupt", name = "中断危险法术", value = true})
    Menu.eset:MenuElement({id = "combo", name = "组合（击晕）", value = true})
    Menu.eset:MenuElement({id = "harass", name = "哈拉斯（眩晕）", value = false})
    Menu.eset:MenuElement({name = "使用（晕眩）：", id = "useonstun", type = _G.MENU})
    ...
    --R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    Menu.rset:MenuElement({id = "qready", name = "只有Q准备好或几乎准备好了", value = true})
    Menu.rset:MenuElement({id = "combo", name = "组合 - 如果X附近的敌人vayne", value = true})
    Menu.rset:MenuElement({id = "xcount", name = "^^^ X敌人^^^", value = 3, min = 1, max = 5, step = 1})
    Menu.rset:MenuElement({id = "xdistance", name = "^^^最大。距离^^^", value = 500, min = 250, max = 750, step = 50})
end
...
function Brand:CreateMenu()
    Menu = MenuElement({name = "Gamsteron品牌", id = "Gamsteron_Brand", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/x1xxbrandx3xx.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    -- KS
    Menu.qset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    ...
    -- Auto
    Menu.qset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.qset.auto:MenuElement({id = "stun", name = "自动眩晕", value = true})
    Menu.qset.auto:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- Combo / Harass
    Menu.qset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.qset.comhar:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset.comhar:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.qset.comhar:MenuElement({id = "stun", name = "只有在昏迷的时候", value = true})
    Menu.qset.comhar:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    Menu.wset:MenuElement({id = "disaa", name = "如果准备好或几乎准备就禁用攻击", value = true})
    -- KS
    Menu.wset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    Menu.wset.killsteal:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.wset.killsteal:MenuElement({id = "minhp", name = "最小的敌人生命值", value = 200, min = 1, max = 300, step = 1})
    Menu.wset.killsteal:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- Auto
    Menu.wset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.wset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.wset.auto:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- Combo / Harass
    Menu.wset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.wset.comhar:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.wset.comhar:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.wset.comhar:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- E
    Menu:MenuElement({name = "E设置", id = "eset", type = _G.MENU})
    Menu.eset:MenuElement({id = "disaa", name = "如果准备好或几乎准备就禁用攻击", value = true})
    -- KS
    Menu.eset:MenuElement({name = "KS", id = "killsteal", type = _G.MENU})
    Menu.eset.killsteal:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.eset.killsteal:MenuElement({id = "minhp", name = "最小的敌人生命值", value = 100, min = 1, max = 300, step = 1})
    -- Auto
    Menu.eset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.eset.auto:MenuElement({id = "stun", name = "如果Q准备好了没有碰撞＆W没准备好Q + E的$ mana", value = true})
    Menu.eset.auto:MenuElement({id = "passive", name = "如果Q没准备就好W没准备好$敌人有被动buff", value = true})
    -- Combo / Harass
    Menu.eset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.eset.comhar:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.eset.comhar:MenuElement({id = "harass", name = "骚扰", value = false})
    --R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    -- Auto
    Menu.rset:MenuElement({name = "Auto", id = "auto", type = _G.MENU})
    Menu.rset.auto:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.rset.auto:MenuElement({id = "xenemies", name = "> =目标附近的X敌人", value = 2, min = 1, max = 4, step = 1})
    Menu.rset.auto:MenuElement({id = "xrange", name = "<X距离敌人目标", value = 300, min = 100, max = 600, step = 50})
    -- Combo / Harass
    Menu.rset:MenuElement({name = "组合/骚扰", id = "comhar", type = _G.MENU})
    Menu.rset.comhar:MenuElement({id = "combo", name = "使用R Combo", value = true})
    Menu.rset.comhar:MenuElement({id = "harass", name = "使用R 骚扰", value = false})
    Menu.rset.comhar:MenuElement({id = "xenemies", name = "> =目标附近的X敌人", value = 1, min = 1, max = 4, step = 1})
    Menu.rset.comhar:MenuElement({id = "xrange", name = "<X距离敌人目标", value = 300, min = 100, max = 600, step = 50})
end
...
function Ezreal:CreateMenu()
    Menu = MenuElement({name = "伊泽瑞尔", id = "Gamsteron_Ezreal", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/ezreal.png"})
    -- E Manual
    Menu:MenuElement({name = "手册E.", id = "mane", type = _G.MENU})
    Menu.mane:MenuElement({id = "efake", name = "E假钥匙", value = false, key = string.byte("E")})
    Menu.mane:MenuElement({id = "elol", name = "E LoL Key", value = false, key = string.byte("L")})
    -- Auto Q
    Menu:MenuElement({name = "自动Q", id = "autoq", type = _G.MENU})
    Menu.autoq:MenuElement({id = "enable", name = "启用", value = true, key = string.byte("T"), toggle = true})
    Menu.autoq:MenuElement({id = "mana", name = "Q自动分钟。法力百分比", value = 50, min = 0, max = 100, step = 1})
    Menu.autoq:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    Menu.qset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    Menu.qset:MenuElement({id = "combo", name = "走砍", value = true})
    ...
    Menu.qset.clearm:MenuElement({id = "lhenabled", name = "LastHit已启用", value = true})
    Menu.qset.clearm:MenuElement({id = "lhmana", name = "", value = 50, min = 0, max = 100, step = 5})
    Menu.qset.clearm:MenuElement({id = "lcenabled", name = "LaneClear已启用", value = false})
    Menu.qset.clearm:MenuElement({id = "lcmana", name = "", value = 75, min = 0, max = 100, step = 5})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    Menu.wset:MenuElement({id = "hitchance", name = "命中率", value = 1, drop = {"normal", "high"}})
    Menu.wset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.wset:MenuElement({id = "harass", name = "骚扰", value = false})
    -- Drawings
    Menu:MenuElement({name = "图纸", id = "draws", type = _G.MENU})
    Menu.draws:MenuElement({name = "自动Q", id = "autoq", type = _G.MENU})
    Menu.draws.autoq:MenuElement({id = "enabled", name = "启用", value = true})
    Menu.draws.autoq:MenuElement({id = "size", name = "字体大小", value = 25, min = 1, max = 64, step = 1})
    Menu.draws.autoq:MenuElement({id = "custom", name = "自定义位置", value = false})
    Menu.draws.autoq:MenuElement({id = "posX", name = "文字位置宽度", value = Game.Resolution().x * 0.5 - 150, min = 1, max = Game.Resolution().x, step = 1})
    Menu.draws.autoq:MenuElement({id = "posY", name = "文字位置高度", value = Game.Resolution().y * 0.5, min = 1, max = Game.Resolution().y, step = 1})
    Menu.draws:MenuElement({name = "Q农场", id = "qfarm", type = _G.MENU})
    Menu.draws.qfarm:MenuElement({name = "最后攻击的小兵", id = "lasthit", type = _G.MENU})
    Menu.draws.qfarm.lasthit:MenuElement({name = "启用", id = "enabled", value = true})
    Menu.draws.qfarm.lasthit:MenuElement({name = "颜色", id = "color", color = Draw.Color(150, 255, 255, 255)})
    Menu.draws.qfarm.lasthit:MenuElement({name = "宽度", id = "width", value = 3, min = 1, max = 10})
    Menu.draws.qfarm.lasthit:MenuElement({name = "半径", id = "radius", value = 50, min = 1, max = 100})
    Menu.draws.qfarm:MenuElement({name = "小兵最后一击", id = "almostlasthit", type = _G.MENU})
    Menu.draws.qfarm.almostlasthit:MenuElement({name = "启用", id = "enabled", value = true})
    Menu.draws.qfarm.almostlasthit:MenuElement({name = "颜色", id = "color", color = Draw.Color(150, 239, 159, 55)})
    Menu.draws.qfarm.almostlasthit:MenuElement({name = "宽度", id = "width", value = 3, min = 1, max = 10})
    Menu.draws.qfarm.almostlasthit:MenuElement({name = "半径", id = "radius", value = 50, min = 1, max = 100})
end
...
function Varus:CreateMenu()
    Menu = MenuElement({name = "韦鲁斯", id = "Gamsteron_Varus", type = _G.MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/gsovarussf3f.png"})
    -- Q
    Menu:MenuElement({name = "Q设置", id = "qset", type = _G.MENU})
    Menu.qset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.qset:MenuElement({id = "stacks", name = "如果敌人有3 W堆叠[W被动]", value = true})
    Menu.qset:MenuElement({id = "active", name = "如果varus有W buff [W active]", value = true})
    Menu.qset:MenuElement({id = "range", name = "在AA范围内没有敌人", value = true})
    Menu.qset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- W
    Menu:MenuElement({name = "W设置", id = "wset", type = _G.MENU})
    Menu.wset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.wset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.wset:MenuElement({id = "whp", name = "", value = 50, min = 1, max = 100, step = 1})
    -- E
    Menu:MenuElement({name = "E设置", id = "eset", type = _G.MENU})
    Menu.eset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.eset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu.eset:MenuElement({id = "range", name = "在AA范围内没有敌人", value = true})
    Menu.eset:MenuElement({id = "stacks", name = "如果敌人有3 W堆叠[W被动]", value = false})
    Menu.eset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
    -- R
    Menu:MenuElement({name = "R设置", id = "rset", type = _G.MENU})
    Menu.rset:MenuElement({id = "combo", name = "使用R Combo", value = true})
    Menu.rset:MenuElement({id = "harass", name = "使用R 骚扰", value = false})
    Menu.rset:MenuElement({id = "rci", name = "如果敌人是移动，请使用R.", value = true})
    Menu.rset:MenuElement({id = "rcd", name = "如果敌人距离<X，则使用R.", value = true})
    Menu.rset:MenuElement({id = "rdist", name = "如果敌人距离<X，则使用R.", value = 500, min = 250, max = 1000, step = 50})
    Menu.rset:MenuElement({id = "hitchance", name = "命中率", value = 2, drop = {"normal", "high"}})
end
...
function Katarina:CreateMenu()
    ...
    Menu:MenuElement({type = _G.MENU, id = "Combo", name = "[走砍管理]"})
    Menu.Combo:MenuElement({id = "Q", name = "使用Q", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaQ.png"})
    Menu.Combo:MenuElement({id = "W", name = "使用W", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaW.png"})
    Menu.Combo:MenuElement({id = "E", name = "使用E", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaEWrapper.png"})
    Menu.Combo:MenuElement({id = "R", name = "使用R.", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaR.png"})
    Menu.Combo:MenuElement({id = "Hex", name = "使用Hextech", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaR.png"})
    Menu:MenuElement({type = _G.MENU, id = "RManager", name = "[R管理]"})
    Menu.RManager:MenuElement({id = "Info", name = "每个冠军得分：", type = SPACE})
    Menu.RManager:MenuElement({id = "ComboMode", name = "组合模式[？]", drop = {"Normal", "Soon", "Soon"}, tooltip = "Watch development Thread for Infos!"})
    local count = 0
    for i = 1, Game.HeroCount() do
        local Hero = Game.Hero(i)
    ...
    Menu.RManager:MenuElement({id = "MinR", name = "最低分数投射R.", value = 1, min = 1, max = count * 3})
    Menu:MenuElement({type = _G.MENU, id = "Harass", name = "[骚扰管理]"})
    Menu.Harass:MenuElement({id = "Q", name = "使用Q", value = true})
    Menu.Harass:MenuElement({id = "W", name = "使用W", value = true})
    Menu.Harass:MenuElement({id = "E", name = "使用E", value = false})
    Menu.Harass:MenuElement({id = "Disabled", name = "禁用所有", value = false})
    Menu:MenuElement({type = _G.MENU, id = "Ks", name = "[KS经理]"})
    Menu.Ks:MenuElement({id = "Q", name = "使用Q", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaQ.png"})
    Menu.Ks:MenuElement({id = "W", name = "使用W", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaW.png"})
    Menu.Ks:MenuElement({id = "E", name = "使用E", value = true, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaEWrapper.png"})
    Menu.Ks:MenuElement({id = "R", name = "使用R.", value = false, leftIcon = "http://ddragon.leagueoflegends.com/cdn/6.24.1/img/spell/KatarinaR.png"})
    if myHero:GetSpellData(4).name == "SummonerDot" or myHero:GetSpellData(5).name == "SummonerDot" then
        Menu.Ks:MenuElement({id = "UseIgn", name = "使用点燃", value = false, leftIcon = "http://pm1.narvii.com/5792/0ce6cda7883a814a1a1e93efa05184543982a1e4_hq.jpg"})
    end
    Menu.Ks:MenuElement({id = "Recall", name = "在调用期间禁用", value = true})
    Menu.Ks:MenuElement({id = "Disabled", name = "禁用所有", value = false})
    Menu:MenuElement({type = _G.MENU, id = "Misc", name = "[其他设置]"})
    Menu.Misc:MenuElement({id = "R", name = "R最大范围", value = 450, min = 0, max = 550})
end
...
function Jhin:CreateMenu()
    Menu = MenuElement({name = "烬", id = "gsojhin", type = MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/gsojhin23d.png"})
    Menu:MenuElement({id = "autor", name = "自动R  - >如果jhin有R Buff", value = true})
    Menu:MenuElement({name = "Q设置", id = "qset", type = MENU})
    Menu.qset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.qset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu:MenuElement({name = "W设置", id = "wset", type = MENU})
    Menu.wset:MenuElement({id = "stun", name = "只有昏迷（标记目标）", value = true})
    Menu.wset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.wset:MenuElement({id = "harass", name = "骚扰", value = false})
    Menu:MenuElement({name = "E设置", id = "eset", type = MENU})
    Menu.eset:MenuElement({id = "onlyimmo", name = "只有不动", value = true})
    Menu.eset:MenuElement({id = "combo", name = "走砍", value = true})
    Menu.eset:MenuElement({id = "harass", name = "骚扰", value = false})
end
...
Callback.Add("Load", function()
    ...
    C:CreateMenu()
    Menu:MenuElement({name = "版" .. SupportedChampions[myHero.charName], type = _G.SPACE, id = "verspace"})
