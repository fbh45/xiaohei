...
function Menu:Init
    ...
    self.Main = MenuElement({id = 'GamsteronProject', name = '走砍设置', type = MENU, leftIcon = '/Gamsteron_Orbwalker_Main.png'})
    
    self.Target = self.Main:MenuElement({id = 'Target', name = '目标选择器', type = MENU, leftIcon = '/Gamsteron_Orbwalker_TargetSelector.png'})
    ...
    self.Orbwalker = self.Main:MenuElement({id = 'Orbwalker', name = '走砍', type = MENU, leftIcon = '/Gamsteron_Orbwalker_Orbwalker.png'})
    ...
    self.Orbwalker.General:MenuElement({id = 'AttackTargetKeyUse', name = '攻击目标键使用', value = false})
    ...
    self.Orbwalker.General:MenuElement({id = 'MovementDelay', name = '运动延迟', value = 250, min = 150, max = 500, step = 50})
    ...
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Min', name = '最小', value = 160, min = 150, max = 300, step = 10})
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Max', name = '最大', value = 240, min = 150, max = 400, step = 10})
    ...
    self.SummonerSpells:MenuElement({id = 'Cleanse', name = '净化', type = MENU, leftIcon = '/Gamsteron_Spell_SummonerBoost.png'})
    self.SummonerSpells.Cleanse:MenuElement({id = 'BuffTypes', name = 'Buff 类型', type = MENU})
    ...
    self.SummonerSpells.Cleanse:MenuElement({id = 'Duration', name = 'Buff持续时间> X', value = 500, min = 0, max = 1000, step = 50})
    
    self.Main:MenuElement({id = 'Items', name = '项目', type = MENU, leftIcon = '/Gamsteron_Item_3072.png'})
    ...
    self.Main:MenuElement({id = 'Drawings', name = '图纸', type = MENU, leftIcon = '/Gamsteron_Orbwalker_Drawings.png'})
    ...
    self.AutoLevelUp = self.Main:MenuElement({id = 'AutoLvlUp', name = '自动升级', type = MENU, leftIcon = '/Gamsteron_LevelUp.png'});
    self.AutoLevelUp:MenuElement({id = 'Enabled', name = '启用', value = false})
    self.SkillOrder = self.AutoLevelUp:MenuElement({id = 'SkillOrder' .. myHero.charName, name = '技能顺序', value = 2, drop = {myHero.charName .. ' Most Frequent', myHero.charName .. ' Highest Win'}})
    self.AutoLevelUp:MenuElement({id = 'StartAt', name = '从几级开始', value = 2, min = 1, max = 18, step = 1})
    ...
    self.Main:MenuElement({id = 'CursorDelay', name = '光标延迟', value = 30, min = 30, max = 50, step = 5})
