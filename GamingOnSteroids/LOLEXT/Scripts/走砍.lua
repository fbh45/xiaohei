...
function Menu:Init
    ...
    self.Main = MenuElement({id = "GamOrbMainMenu", name = "走砍", type = MENU, leftIcon = "/Gamsteron.png"})
    self.Main:MenuElement({id = "Loader", name = "装载机", type = MENU, leftIcon = "/Gamsteron_Loader.png"})
    self.Main.Loader:MenuElement({id = "Items", name = "使用物品：", value = true})
    self.Main.Loader:MenuElement({id = "SummonerSpells", name = "召唤师法术", value = true})
    
    self.Target = self.Main:MenuElement({id = 'Target', name = '内置目标选择器', type = MENU, leftIcon = '/Gamsteron_TargetSelector.png'})
    ...
    self.Orbwalker = self.Main:MenuElement({id = 'Orbwalker', name = '更改你的奥宝行者中的键[组合键]！', type = MENU, leftIcon = '/Gamsteron_Orbwalker.png'})
    self.Orbwalker:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Orbwalker:MenuElement({id = 'MovementEnabled', name = '已启用移动', value = true})
    self.Orbwalker:MenuElement({id = 'AttackEnabled', name = '启用攻击', value = true})
    ...
    self.Orbwalker.General:MenuElement({id = 'StickToTarget', name = '坚持目标：只有近战', value = false})
    self.Orbwalker.General:MenuElement({id = 'SkipTargets', name = '移动目标', value = false})
    ...
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Min', name = '最小范围', value = 100, min = 50, max = 300, step = 10})
    self.Orbwalker.RandomHumanizer:MenuElement({id = 'Max', name = '最大范围', value = 150, min = 150, max = 400, step = 10})
    self.Orbwalker:MenuElement({id = 'Farming', name = '养殖设置', type = MENU})
    self.Orbwalker.Farming:MenuElement({id = 'LastHitPriority', name = '优先考虑最后一次骚扰', value = true})
    self.Orbwalker.Farming:MenuElement({id = 'PushPriority', name = '优先推送冻结', value = true})
    self.Orbwalker.Farming:MenuElement({id = 'ExtraFarmDelay', name = '额外农场延迟', value = 0, min = -80, max = 80, step = 10})
    
    if self.Main.Loader.SummonerSpells:Value() then
        self.SummonerSpellsLoaded = true
        self.SummonerSpells = self.Main:MenuElement({id = 'SummonerSpells', name = '召唤师技能', type = MENU, leftIcon = "/Gamsteron_Spell_SummonerFlash.png"})
        self.SummonerSpells:MenuElement({id = 'Cleanse', name = '使用：净化', type = MENU, leftIcon = '/Gamsteron_Spell_SummonerBoost.png'})
        self.SummonerSpells.Cleanse:MenuElement({id = 'BuffTypes', name = '增益类型', type = MENU})
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Slow', name = '减速 内瑟斯 w', value = true})--SLOW = 10 -> nasus W, zilean E
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Stun', name = '眩晕 娑娜 r', value = true})--STUN = 5
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Snare', name = '倒钩 霞 e', value = true})--SNARE = 11
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Supress', name = '压制 沃里克 r', value = true})--SUPRESS = 24
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Knockup', name = '击飞 亚索 q3', value = true})--KNOCKUP = 29
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Fear', name = '恐惧 费德提克 q', value = true})--FEAR = 21 -> fiddle Q, ...
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Charm', name = '魅惑 阿狸 e', value = true})--CHARM = 22 -> ahri E, ...
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Taunt', name = '嘲讽 拉莫斯 e', value = true})--TAUNT = 8 -> rammus E, ...
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Knockback', name = '击退 阿利斯塔 w', value = true})--KNOCKBACK = 30 -> alistar W, lee sin R, ...
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Blind', name = '致盲 提莫 q', value = true})--BLIND = 25 -> teemo Q
        self.SummonerSpells.Cleanse.BuffTypes:MenuElement({id = 'Disarm', name = '变形 璐璐 w', value = true})--DISARM = 31 -> Lulu W
        self.SummonerSpells.Cleanse:MenuElement({id = 'Enabled', name = '启用', value = true})
        self.SummonerSpells.Cleanse:MenuElement({id = 'Count', name = '敌人数', value = 1, min = 0, max = 5, step = 1})
        self.SummonerSpells.Cleanse:MenuElement({id = 'Distance', name = '敌人距离<X', value = 1200, min = 0, max = 1500, step = 50})
        self.SummonerSpells.Cleanse:MenuElement({id = 'Duration', name = '增益持续时间> X', value = 500, min = 0, max = 1000, step = 50})
    end
    
    if self.Main.Loader.Items:Value() then
        self.ItemsLoaded = true
        self.Main:MenuElement({id = 'Items', name = '使用物品：', type = MENU, leftIcon = '/Gamsteron_Item_3072.png'})
        self.Main.Items:MenuElement({id = 'Qss', name = '水银弯刀', type = MENU})
        self.Main.Items.Qss:MenuElement({id = 'BuffTypes', name = '增益类型', type = MENU})
        ...
        self.Main.Items.Qss:MenuElement({id = 'Duration', name = '增益持续时间> X', value = 500, min = 0, max = 1000, step = 50})
        self.Main.Items:MenuElement({id = 'Botrk', name = '使用 比尔吉沃特弯刀/破板王者之刃', type = MENU})
    ...
    self.Main:MenuElement({id = 'Drawings', name = '图纸', type = MENU, leftIcon = '/Gamsteron_Drawings.png'})
    self.Main.Drawings:MenuElement({id = 'Enabled', name = '启用', value = true})
    self.Main.Drawings:MenuElement({id = 'Cursor', name = '光标位置', value = true})
    self.Main.Drawings:MenuElement({id = 'Range', name = '敌人自动攻击范围', value = true})
    ...
    self.Main:MenuElement({id = 'AttackTKey', name = '快捷指定攻击键', key = string.byte('U'), tooltip = 'You should bind this one in ingame settings'})
    self.Main:MenuElement({id = 'Latency', name = 'Ping [ms]', value = 50, min = 0, max = 120, step = 1, callback = function(value) _G.LATENCY = value end})
    self.Main:MenuElement({id = 'CursorDelay', name = '额外光标延迟', value = 30, min = 30, max = 50, step = 5})
    
    self.Main:MenuElement({name = '', type = _G.SPACE, id = 'VersionSpaceA'})
    self.Main:MenuElement({name = '版' .. Version, type = _G.SPACE, id = 'VersionSpaceB'})
...
function Buff:CreateBuffs(unit)
    local result = {}
...
function Buff:HasBuffContainsName(unit, str)
    str = str:lower()
    local id = unit.networkID
    if self.CachedBuffs[id] == nil then self.CachedBuffs[id] = self:CreateBuffs(unit) end
...
function Buff:HasBuffTypes(unit, types)
    local id = unit.networkID
    if self.CachedBuffs[id] == nil then self.CachedBuffs[id] = self:CreateBuffs(unit) end
    for name, buff in pairs(self.CachedBuffs[id]) do
...
function Data:TotalShieldHealth(target)
...
function Data:IsOtherMinion(unit)
...
function Data:IsLaneMinion(unit)
...
function Spell:CheckSpellDelays2(delays)
    local timer = Game.Timer()
...
Item =
{
    ...
    ITEM_HYDRA =
    {
        ['tia'] = {name = '提亚马特/贪欲九头蛇', id = 3077, range = 300},
        ['hyd'] = {name = '贪欲九头蛇', id = 3074, range = 300},
        ['tit'] = {name = '巨型九头蛇', id = 3748, range = 300},
    },
 
    ITEM_SKILLSHOT =
    {
        ['pro'] = {name = '海克斯科技原型腰带-01', id = 3152, range = 800},
        ['glp'] = {name = '海克斯科技GLP-800', id = 3030, range = 800},
    },]]
